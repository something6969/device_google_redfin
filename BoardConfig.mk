...
DEVICE_MANIFEST_FILE += $(DEVICE_PATH)/android.hardware.audio.sounddose-aidl.xml
DEVICE_MANIFEST_FILE += $(DEVICE_PATH)/android.hardware.authsecret-service.citadel.xml
...
DEVICE_MANIFEST_FILE += $(DEVICE_PATH)/android.hardware.oemlock-service.citadel.xml
...
DEVICE_MANIFEST_FILE += $(DEVICE_PATH)/android.hardware.weaver-service.citadel.xml
...
DEVICE_MANIFEST_FILE += $(DEVICE_PATH)/manifest_wifi_ext_aidl.xml
...
DEVICE_MANIFEST_FILE += $(DEVICE_PATH)/vendor.google.wireless_charger-default.xml
